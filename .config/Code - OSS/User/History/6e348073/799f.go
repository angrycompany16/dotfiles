...
func newLevel(levelLDTK *ebitenLDTK.Level, defs *ebitenLDTK.Defs) (*Level, error) {
	...
	newLevel.lightsShader = errs.Must(ebiten.NewShader(assets.Lights_kage))
...
func (l *Level) Draw(playerX, playerY float64) {
	...
	shaderOp.Blend = ebiten.BlendSourceAtop
	rendering.RenderLayers.Foreground.DrawRectShader(rendering.GameWidth, rendering.GameHeight, l.lightsShader, &shaderOp)
