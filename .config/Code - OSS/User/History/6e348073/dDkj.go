...
func (l *Level) Draw(playerX, playerY float64) {
	...
	rendering.RenderLayers.Playerspace.DrawRectShader(rendering.GameWidth, rendering.GameHeight, l.lightsAdditiveShader, &shaderOp)

	shaderOp.Blend = ebiten.BlendSourceOver
	rendering.RenderLayers.Playerspace.DrawRectShader(rendering.GameWidth, rendering.GameHeight, l.lightsSubtractiveShader, &shaderOp)
