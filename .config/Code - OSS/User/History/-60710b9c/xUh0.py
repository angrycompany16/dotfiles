...
def solve_mean_estimate():
    ...
    omega_average_estimates = [np.zeros(len(task1.SNRs_in_dB)) for i in range(task1.FFT_sizes)]
    phi_average_estimates = [np.zeros(len(task1.SNRs_in_dB)) for i in range(task1.FFT_sizes)]
    ...
    task1.plot_average_omega_against_snr(omega_average_estimate_array)
    task1.plot_average_phi_against_snr(phi_average_estimate_array)
