...
var (
	_camera                      = &Camera{}
	shakePaddingX, shakePaddingY = 20.0, 20.0
)
...
func SetPos(x, y float64) {
	...
	_camera.posX = maths.Clamp(x-_camera.offsetX-_camera.shakeOffsetX, -shakePaddingX, _camera.width-rendering.GameWidth+shakePaddingY)
