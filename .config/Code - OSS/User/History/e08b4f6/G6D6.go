...
// TODO: Make SetPos work differently
// Implement camera shake in the renderer itself?
func SetPos(x, y float64) {
	...
	fmt.Println(_camera.shakeOffsetX)
	_camera.posX = maths.Clamp(x-_camera.offsetX-_camera.shakeOffsetX, 0, _camera.width-rendering.GameWidth)
	_camera.posY = maths.Clamp(y-_camera.offsetY-_camera.shakeOffsetY, _camera.screenPadding/2, _camera.height-rendering.GameHeight-_camera.screenPadding/2)
}
