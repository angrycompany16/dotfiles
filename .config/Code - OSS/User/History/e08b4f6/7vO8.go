...
func SetPos(x, y float64) {
	...
	_camera.posX = maths.Clamp(x-_camera.offsetX-_camera.shakeOffsetX, _camera.screenPadding/2, _camera.width-rendering.GameWidth-_camera.screenPadding/2)
	_camera.posY = maths.Clamp(y-_camera.offsetY-_camera.shakeOffsetY, 0, _camera.height-rendering.GameHeight)
}
